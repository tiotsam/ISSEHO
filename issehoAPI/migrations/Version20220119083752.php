 ...
 */
final class Version20220119083752 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cours (id INT AUTO_INCREMENT NOT NULL, auteur_id INT NOT NULL, niveau_id INT NOT NULL, matieres_id INT NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, INDEX IDX_FDCA8C9C60BB6FE6 (auteur_id), INDEX IDX_FDCA8C9CB3E9C81 (niveau_id), INDEX IDX_FDCA8C9C82350831 (matieres_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
