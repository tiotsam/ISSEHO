 ...
 */
final class Version20220210094742 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cours (id INT AUTO_INCREMENT NOT NULL, auteur_id INT NOT NULL, niveau_id INT NOT NULL, matieres_id INT NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, max_participants INT NOT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_FDCA8C9C60BB6FE6 (auteur_id), INDEX IDX_FDCA8C9CB3E9C81 (niveau_id), INDEX IDX_FDCA8C9C82350831 (matieres_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE questions (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(255) NOT NULL, cible VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reponses (id INT AUTO_INCREMENT NOT NULL, question_id INT NOT NULL, user_id INT NOT NULL, label VARCHAR(255) NOT NULL, INDEX IDX_1E512EC61E27F6BF (question_id), INDEX IDX_1E512EC6A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, infos_id INT DEFAULT NULL, enfants_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D649544A4CCA (infos_id), INDEX IDX_8D93D649A586286C (enfants_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
