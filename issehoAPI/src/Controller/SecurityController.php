...
class SecurityController extends AbstractController
{
    ...
    public function index(Request $request): Response
    {
        try{
            ...
            $this->service->register($post['email'], $post['prenom'] , $post['nom'],$post['password'] , $post['role'] , $post['rue'] , $post['departement'] , $post['ville'] , $post['birthdate'] , $post['dateInscription'] , $post['image'] = null , $post['parent'] = null);
        }
        catch(Exception $e){
